...
export default function About() {
    return (
        <section id="1" className="h-screen max-desktop:h-auto max-desktop:pt-[140px] max-desktop:pb-[60px] wrapper flex flex-col items-center justify-center gap-14 max-laptop:gap-10">
            <div className="grid grid-cols-2 max-desktop:flex flex-col items-center gap-16">
                <div className="flex flex-col gap-y-14">
                    <h3 className="text-base-color font-bold font-base text-2xl max-laptop:text-xl max-tablet:text-lg">Нужен сайт или веб-приложение?<br/>
                    <span className="text-bright font-bold text-2xl max-laptop:text-xl max-tablet:text-lg">Вы по адресу!</span></h3>
                    <h1 className="text-dark-base text-5xl max-laptop:text-4xl max-tablet:text-3xl font-attention uppercase">Веб-разработка под ключ</h1>
            ...
            <button onClick={() => {
                ...
                <span className="text-white font-normal text-2xl max-laptop:text-xl max-tablet:text-lg">Наши работы</span>
